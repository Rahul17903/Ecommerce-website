...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8 text-white">
            <h1 className="text-3xl font-semibold mb-4">About Get Me a Book</h1>
            <p className="text-lg mb-6">
                My website is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a book. Unlock the potential of your fanbase and bring your projects to life.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="flex items-center mb-6">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-2">Support Through purchases Book</h3>
                        <p>Receive support from your fans in the form of Book purchases, directly contributing to your project funding.</p>
                    </div>
                </div>
